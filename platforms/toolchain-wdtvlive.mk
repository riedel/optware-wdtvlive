...
CROSS_CONFIGURATION_GLIBC_VERSION=2.8
...
#TARGET_CROSS = $(TARGET_CROSS_TOP)/bin/mips-linux-gnu-
TARGET_LIBDIR = $(TARGET_CROSS_TOP)/lib
TARGET_INCDIR = $(TARGET_CROSS_TOP)/include
TARGET_LDFLAGS =  -ggdb -Wl,-melf32ltsmip 
#TARGET_CC="$(TARGET_CROSS)gcc -EL" 
#TARGET_CPP="$(TARGET_CROSS)gcc -EL -E"
#TARGET_CXX="$(TARGET_CROSS)g++ -EL" 
#TARGET_AS="$(TARGET_CROSS)as -EL"
#TARGET_LD="$(TARGET_CROSS)ld -EL"
